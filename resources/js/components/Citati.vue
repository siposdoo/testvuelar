...
<div class="modal fade"    id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <div class="form-group">
        <textarea type="text" v-model="citat.text" placeholder="Tekst" class="form-control"></textarea>
    </div>
...
<nav aria-label="Page navigation example">
  <ul class="pagination">
    <li v-bind:class="[{disabled:!pagination.prev_page_url}]" class="page-item"><a @click="fetchCitati(pagination.prev_page_url);" class="page-link" href="#">Prethodna</a></li>
    <li  class="page-item disabled"><a class="page-link">{{pagination.current_page}} od {{pagination.last_page}}</a></li>
    <li v-bind:class="[{disabled:!pagination.next_page_url}]" class="page-item"><a  @click="fetchCitati(pagination.next_page_url);" class="page-link" href="#">Sledeca</a></li>
  </ul>
</nav>
