...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Citati.vue?vue&type=script&lang=js&":
/*!*****************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/Citati.vue?vue&type=script&lang=js& ***!
  \*****************************************************************************************************************************************************************/
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    fetchCitati: function fetchCitati(url_p) {
      var _this = this;

      var mm = this;
      url_p = url_p || 'api/articles';
      fetch(url_p).then(function (res) {
        return res.json();
      }).then(function (res) {
        _this.citati = res.data;
        mm.makePagination(res.meta, res.links);
      })["catch"](function (err) {
        return console.log(err);
      });
    },
    makePagination: function makePagination(m, l) {
      var pagination = {
    ...
    brisiCitat: function brisiCitat(id) {
      var _this2 = this;
      ...
      if (confirm('Da li ste sigurni?')) {
        fetch("api/article/".concat(id), {
          ...
          _this2.fetchCitati(_this2.pagination.current_page_url);
        });
      }
    },
    dodajCitat: function dodajCitat() {
      var _this3 = this;
      ...
      if (this.edit === false) {
        fetch('api/article', {
          ...
          _this3.fetchCitati(_this3.pagination.current_page_ur);
        })["catch"](function (err) {
          return console.log(err);
        });
      } else {
    ...
    editCitat: function editCitat(citat) {
      this.edit = true;
  ...
  methods: {
    checkForm: function checkForm(e) {
      ...
      if (!this.password) {
        ...
        })["catch"](function (erraa) {
          return console.log(erraa);
        });
      }
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Citati.vue?vue&type=template&id=a7c2ed9a&":
/*!*********************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/Citati.vue?vue&type=template&id=a7c2ed9a& ***!
  \*********************************************************************************************************************************************************************************************************/
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("h2", [_vm._v("Citati " + _vm._s(_vm.totalc))]),
      _vm._v(" "),
      _c(
        "button",
        {
                          ...
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.citat.naziv,
                              expression: "citat.naziv"
                            }
                          ],
                          staticClass: "form-control",
                          attrs: { type: "text", placeholder: "Naziv" },
                          domProps: { value: _vm.citat.naziv },
                          on: {
                            input: function($event) {
                              if ($event.target.composing) {
                                return
                              }
                              _vm.$set(_vm.citat, "naziv", $event.target.value)
                            }
                          }
                        })
                      ]),
                          ...
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.citat.text,
                              expression: "citat.text"
                            }
                          ],
                          staticClass: "form-control",
                          attrs: { type: "text", placeholder: "Tekst" },
                          domProps: { value: _vm.citat.text },
                          on: {
                            input: function($event) {
                              if ($event.target.composing) {
                                return
                              }
                              _vm.$set(_vm.citat, "text", $event.target.value)
                            }
                          }
                        })
                      ])
                ...
                "a",
                {
                  ...
                  on: {
                    click: function($event) {
                      return _vm.fetchCitati(_vm.pagination.prev_page_url)
                    }
                  }
                },
                [_vm._v("Prethodna")]
            ...
            [
              _c(
                "a",
                {
                  ...
                  on: {
                    click: function($event) {
                      return _vm.fetchCitati(_vm.pagination.next_page_url)
                    }
                  }
                },
                [_vm._v("Sledeca")]
      ...
      _vm._v(" "),
      _vm._l(_vm.citati, function(citat) {
        return _c(
          "div",
          { key: citat.id, staticClass: "card card-body mb-2" },
          [
            _c("h3", [_vm._v(_vm._s(citat.naziv))]),
            _vm._v(" "),
            _c("p", [_vm._v(_vm._s(citat.text))]),
            _vm._v(" "),
            _c("div", { staticClass: "col-md-12 " }, [
              _c(
                "button",
                {
                  staticClass: "btn btn-warning mr-2 mb-2 float-right",
                  on: {
                    click: function($event) {
                      return _vm.editCitat(citat)
                    }
                  }
                },
                [_vm._v("Izmjeni")]
              ...
              _c(
                "button",
                {
                  staticClass: "btn btn-danger mr-2 mb-2 float-right",
                  on: {
                    click: function($event) {
                      return _vm.brisiCitat(citat.id)
                    }
                  }
                },
                [_vm._v("Obriši")]
  ...
  return _c("div", { staticClass: "container" }, [
    _c("div", { staticClass: "row justify-content-center" }, [
      ...
      _c("div", { staticClass: "col-md-12 text-center" }, [
        _vm.errors.length
          ? _c("p", [
              _c("b", [_vm._v("Doslo je do greske:")]),
              _vm._v(" "),
              _c(
                "ul",
                ...
                _vm._l(_vm.errors, function(error) {
                  return _c(
                    ...
                    {
                      key: error,
                      staticClass: "list-group-item list-group-item-danger mb-3"
                    },
                    [_vm._v(_vm._s(error))]
                  )
                }),
        ...
        ? _c("div", { staticClass: "col-md-6" }, [
            _c(
              ...
              [
                ...
                _vm._v(" "),
                _c("div", { staticClass: "form-group" }, [
                  _c("label", { attrs: { for: "pwd" } }, [_vm._v("Lozinka:")]),
                  _vm._v(" "),
                  _c("input", {
                    directives: [
                      {
    ...
    [
      _c("div", { staticClass: "contaner" }, [
        ...
        _vm.logovan
          ? _c(
              "a",
              {
                ...
                attrs: { href: "/administracija" }
              },
              [_vm._v("Administracija")]
            )
          : _vm._e(),
        _vm._v(" "),
        _vm.logovan
        ...
        !_vm.logovan
          ? _c(
              "a",
              { staticClass: "navbar-brand", attrs: { href: "/vuelogin" } },
              [_vm._v("Prijava")]
            )
          : _vm._e()
      ])
...
Vue.component('citati-controller', __webpack_require__(/*! ./components/Citati.vue */ "./resources/js/components/Citati.vue")["default"]);
Vue.component('navbar-controller', __webpack_require__(/*! ./components/Navbar.vue */ "./resources/js/components/Navbar.vue")["default"]);
Vue.component('home-controller', __webpack_require__(/*! ./components/Home.vue */ "./resources/js/components/Home.vue")["default"]);
...
/***/ "./resources/js/components/Citati.vue":
/*!********************************************!*\
  !*** ./resources/js/components/Citati.vue ***!
  \********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Citati_vue_vue_type_template_id_a7c2ed9a___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Citati.vue?vue&type=template&id=a7c2ed9a& */ "./resources/js/components/Citati.vue?vue&type=template&id=a7c2ed9a&");
/* harmony import */ var _Citati_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Citati.vue?vue&type=script&lang=js& */ "./resources/js/components/Citati.vue?vue&type=script&lang=js&");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _Citati_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _Citati_vue_vue_type_template_id_a7c2ed9a___WEBPACK_IMPORTED_MODULE_0__["render"],
  _Citati_vue_vue_type_template_id_a7c2ed9a___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/Citati.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/components/Citati.vue?vue&type=script&lang=js&":
/*!*********************************************************************!*\
  !*** ./resources/js/components/Citati.vue?vue&type=script&lang=js& ***!
  \*********************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Citati_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/babel-loader/lib??ref--4-0!../../../node_modules/vue-loader/lib??vue-loader-options!./Citati.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Citati.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Citati_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/components/Citati.vue?vue&type=template&id=a7c2ed9a&":
/*!***************************************************************************!*\
  !*** ./resources/js/components/Citati.vue?vue&type=template&id=a7c2ed9a& ***!
  \***************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Citati_vue_vue_type_template_id_a7c2ed9a___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib??vue-loader-options!./Citati.vue?vue&type=template&id=a7c2ed9a& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Citati.vue?vue&type=template&id=a7c2ed9a&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Citati_vue_vue_type_template_id_a7c2ed9a___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Citati_vue_vue_type_template_id_a7c2ed9a___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
...
__webpack_require__(/*! C:\AppServ\www\testvuelar\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\AppServ\www\testvuelar\resources\sass\app.scss */"./resources/sass/app.scss");
